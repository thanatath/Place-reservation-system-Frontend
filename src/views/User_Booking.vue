  ...
  <div class="container" style="margin-top:1%;margin-bottom:1%;">
    <div class="row">
      <div class="col">
        ...
        <div v-show="notitarget" class="card" style="width:100%;margin-bottom:15px;padding:12px;">
          <img class="card-img-top" :src="notitarget_Img" alt="Card image cap" />
          <div class="card-body">
            ...
            <div class="input-group" style="margin-top:15px;">
              ...
              <textarea v-model="description" class="form-control" aria-label="รายละเอียด"></textarea>
            </div>
          </div>

<div class="text-right">
  
  <button type="button" @click="noti_Action" style="margin-right:15px;" class="btn btn-warning">แจ้งเรื่อง</button>
  <button type="button" @click="notitarget=null;" class="btn btn-dark">ยกเลิก</button>
        ...
        <table class="table">
          ...
          <tbody v-for="item in mybooked" :key="item.id">
            <tr>
              ...
              <td>
                <button type="button" @click="noti(item.get('Place_id'))" class="btn btn-warning">
                  แจ้งเรื่อง
                </button>
              </td>
            </tr>
